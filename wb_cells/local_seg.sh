...
# Mar 10, 2021
python train_mask2.py --docker False --gpu 1 --net_type Unet --backbone efficientnetb0 --epoch 2400 --dim 1024 --dataset wbc4_1024x1024 --loss focal+dice --batch 2 --lr 1e-4 --focal_weight 4 --bk 1