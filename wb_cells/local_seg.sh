...
python train_seg.py --docker True --gpu 0 --net_type Unet --backbone efficientnetb1 --epoch 2400 --dim 928 --dataset wbc2_1024x1024 --loss ce --batch 2 --lr 1e-4 --focal_weight 4 --bk 1