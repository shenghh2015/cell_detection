...
JOB: python train_crop_mask.py --gpu 0 --net_type Unet --backbone efficientnetb6 --epoch 4800 --dim 384 --dataset wbc4_1024x1024 --loss focal+dice --batch 8 --lr 5e-4 --focal_weight 4 --bk 1 --rot 10 --max_min max --valid False
JOB: python train_crop_mask.py --gpu 1 --net_type Unet --backbone efficientnetb6 --epoch 4800 --dim 384 --dataset wbc4_1024x1024 --loss focal+dice --batch 8 --lr 5e-4 --focal_weight 4 --bk 1 --rot 10 --max_min max --valid True
JOB: python train_mask2.py --gpu 2 --net_type Unet --backbone efficientnetb4 --epoch 2400 --dim 1024 --batch_size 2 --lr 1e-4 --dataset wbc4_1024x1024 --valid False
JOB: python train_mask2.py --gpu 3 --net_type Unet --backbone efficientnetb4 --epoch 2400 --dim 1024 --batch_size 2 --lr 1e-4 --dataset wbc_1024x1024 --valid False