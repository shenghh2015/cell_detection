...
JOB: python train_crop_mask.py --gpu 2 --net_type Unet --backbone efficientnetb6 --epoch 4800 --dim 384 --dataset wbc2_1024x1024 --loss focal --batch 8 --lr 1e-4 --focal_weight 4 --bk 1 --rot 20
