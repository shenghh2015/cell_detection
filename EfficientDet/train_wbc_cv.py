...
def parse_args(args):
    ...
    parser.add_argument('--val-annotations-path',
                            help='Path to CSV file containing annotations for validation (optional).', default = '')
    ...
    parser.add_argument('--freeze-bn', help='Freeze training of BatchNormalization layers.', action='store_true', default= False)
    ...
    parser.add_argument('--tensorboard_dir', help='Log directory for Tensorboard output',
    ...
    # 
    parser.add_argument('--docker', help='If run in a docker container or not', action='store_true')
...
def main(args=None):
    ...
    if args.valid:
        ...
        if args.cross < 1:
            ...
            train_annot_path = dataset_dir + '/cv_sets/cv{}_train_{}c.csv'.format(args.cross, args.cls)
            valid_annot_path = dataset_dir + '/cv_sets/cv{}_test_{}c.csv'.format(args.cross, args.cls)
    ...
    model_name = 'phi-{}-set-{}-wfpn-{}-ep-{}-stp-{}-bz-{}-snap-{}-cls-{}-valid-{}-cross-{}-lr-{}-lw-{}'.format(args.phi, args.dataset,\
