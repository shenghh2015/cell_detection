...
JOB: python3 train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid False --phi 0 --gpu 0 --batch-size 16 --steps 50 --epoch 400 --aug False --bstrp 1 --lr 1e-4 --lw 0.5
JOB: python3 train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid False --phi 0 --gpu 1 --batch-size 16 --steps 50 --epoch 400 --aug False --bstrp 2 --lr 1e-4 --lw 0.5
JOB: python3 train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid False --phi 0 --gpu 2 --batch-size 16 --steps 50 --epoch 400 --aug False --bstrp 3 --lr 1e-4 --lw 0.5
JOB: python3 train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid False --phi 0 --gpu 3 --batch-size 16 --steps 50 --epoch 400 --aug False --bstrp 4 --lr 1e-4 --lw 0.5