...
# Aug 15 2021
JOB: train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid True --phi 0 --gpu 0 --batch-size 16 --steps 100 --epoch 200 --aug False --bstrp 0 --lr 5e-5 --lw 0.5 --nb 350
JOB: train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid True --phi 0 --gpu 1 --batch-size 16 --steps 100 --epoch 200 --aug False --bstrp 1 --lr 5e-5 --lw 0.5 --nb 350
JOB: train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid True --phi 0 --gpu 2 --batch-size 16 --steps 100 --epoch 200 --aug False --bstrp 2 --lr 5e-5 --lw 0.5 --nb 350
JOB: train_wbc_bootstrap.py --docker --snapshot imagenet --dataset wbc5_1024x1024 --valid True --phi 0 --gpu 3 --batch-size 16 --steps 100 --epoch 200 --aug False --bstrp 3 --lr 5e-5 --lw 0.5 --nb 350