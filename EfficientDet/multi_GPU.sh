...
JOB: python3 train_wbc_cv.py --docker --snapshot imagenet --dataset wbc_1024x1024 --cls 4 --phi 0 --gpu 2 --batch-size 12 --steps 100 --epoch 200 --valid False --cross 3
JOB: python3 train_wbc_cv.py --docker --snapshot imagenet --dataset wbc_1024x1024 --cls 4 --phi 0 --gpu 3 --batch-size 12 --steps 100 --epoch 200 --valid False --cross 4