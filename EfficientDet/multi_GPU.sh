...
# Mar 2, 2021
JOB: python3 train_wbc.py --docker --snapshot imagenet --phi 5 --gpu 0 --batch-size 4 --epoch 200 --steps 1000 --dataset wbc_1024x1024
JOB: python3 train_wbc.py --docker --snapshot imagenet --phi 5 --gpu 1 --batch-size 4 --epoch 200 --steps 1000 --dataset wbc2_1024x1024
JOB: python3 train_wbc.py --docker --snapshot imagenet --phi 5 --gpu 2 --batch-size 4 --epoch 200 --steps 1000 --dataset wbc3_1024x1024
JOB: python3 train_wbc.py --docker --snapshot imagenet --phi 6 --gpu 3 --batch-size 2 --epoch 200 --steps 1000 --dataset wbc_1024x1024