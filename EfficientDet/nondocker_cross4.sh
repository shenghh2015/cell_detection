...
python3 train_wbc_cv.py --snapshot imagenet --dataset wbc4_1024x1024 --cls 5 --phi 1 --gpu 0 --batch-size 4 --steps 100 --epoch 200 --valid False --cross 3
python3 train_wbc_cv.py --snapshot imagenet --dataset wbc4_1024x1024 --cls 5 --phi 1 --gpu 0 --batch-size 4 --steps 100 --epoch 200 --valid False --cross 4