...
def main():
		...
		cls = 4
		model_name_list = ['phi-0-set-wbc5_1024x1024-wfpn-False-ep-200-stp-100-bz-4-snap-imagenet-cls-4-valid-False-aug-False',
											 'phi-0-set-wbc5_1024x1024-wfpn-False-ep-200-stp-100-bz-4-snap-imagenet-cls-4-valid-False-aug-True',
											]
# 		cls = 5
